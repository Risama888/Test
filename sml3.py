...
# Variabel untuk menyimpan status sinyal terakhir
last_signal = None
...
while True:
    try:
        ...
        # Jika sinyal berbeda dari sebelumnya, kirim pesan
        current_signal = supertrend_signal
        ...
        # Tunggu selama 5 menit sebelum cek lagi
        time.sleep(30)  # 300 detik = 5 menit

    except Exception as e:
        print(f"Terjadi error: {e}")
        # Jika error, tunggu sebentar dan coba lagi
        time.sleep(30)
